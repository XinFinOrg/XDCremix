...
class FetchAndCompile extends engine_1.Plugin {
    ...
    resolve(contractAddress, codeAtAddress, targetPath) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            let data;
            try {
                data = yield this.call('source-verification', 'fetchByNetwork', contractAddress, network.id);
            }
            catch (e) {
            ...
            yield this.call('fileManager', 'setFile', `${targetPath}/${network.id}/${contractAddress}/metadata.json`, JSON.stringify(data.metadata, null, '\t'));
            ...
            try {
                ...
                const compData = yield (0, remix_solidity_1.compile)(compilationTargets, settings, (url, cb) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () { return yield this.call('contentImport', 'resolveAndSave', url).then((result) => cb(null, result)).catch((error) => cb(error.message)); }));

...
`remixd -s <absolute-path-to-the-shared-folder> --remix-ide https://remix.xinfin.network`

Make sure that if you use https://remix.xinfin.network (secure http) in the remixd command (like in the example above), that you are also pointing your browser to https://remix.xinfin.network and not to http://remix.xinfin.network (plain old insecure http).  Or if you want to use http in the browser use http in the remixd command.
